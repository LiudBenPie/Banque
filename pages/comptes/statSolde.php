...
try {
    ...
    echo "La somme des soldes des compte client est de : " . $result['somme_solde'];
    
    // Requête SQL pour récupérer les soldes des client
    ...
    var myChart = new Chart(ctx, {
        ...
        options: {
            plugins: {
                title: {
                    display: true,
                    text: "répartion des soldes des client"
                }
            },
        }
    });
