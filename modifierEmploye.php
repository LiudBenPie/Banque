        ...
        <form action="modifierEmploye.php" method="post" name='monForm'>
            ...
            <p>
                ...
                <input type="text" id="nom" name="nom"
                    value="<?php echo isset($employe['nom']) ? htmlspecialchars($employe['nom']) : ''; ?>">
            </p>

            <p>
                <label for="login">Login:</label>
                <input type="text" id="login" name="login"
                    value="<?php echo isset($employe['login']) ? htmlspecialchars($employe['login']) : ''; ?>">
            </p>
            ...
            <p>
                ...
                <select id="categorie" name="categorie">
                    <option value="Conseiller"
                        <?php echo (isset($employe['categorie']) && $employe['categorie'] == 'Conseiller') ? 'selected' : ''; ?>>
                        Conseiller</option>
                    <option value="Agent"
                        <?php echo (isset($employe['categorie']) && $employe['categorie'] == 'Agent') ? 'selected' : ''; ?>>
                        Agent</option>
                    <option value="Directeur"
                        <?php echo (isset($employe['categorie']) && $employe['categorie'] == 'Directeur') ? 'selected' : ''; ?>>
                        Directeur</option>
                </select>
            </p>
